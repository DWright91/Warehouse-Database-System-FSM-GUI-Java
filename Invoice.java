...
public class Invoice implements Serializable {
    ...
    public Invoice(Client client, List<Product> products, List<Integer> quantities, List<Double> unitPrices) {
        ...
        // Set the invoice date to the current date and time when the invoice is created
        this.invoiceDate = LocalDateTime.now();
    }

 // Getter method for retrieving the invoice date
    public LocalDateTime getInvoiceDate() {
        return invoiceDate;
    }

    // Setter method for setting the invoice date
